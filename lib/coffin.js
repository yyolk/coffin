...
(function() {
  ...
  CloudFormationTemplateContext = (function() {
    ...
    CloudFormationTemplateContext.prototype._resourceByType = function(type, name, props) {
      var result;
      result = {};
      if (((props != null ? props.Metadata : void 0) != null) || ((props != null ? props.Properties : void 0) != null) || ((props != null ? props.DependsOn : void 0) != null) || ((props != null ? props.UpdatePolicy : void 0) != null) || ((props != null ? props.CreationPolicy : void 0) != null) || ((props != null ? props.DeletionPolicy : void 0) != null) || ((props != null ? props.Condition : void 0) != null)) {
        result[name] = props;
        result[name].Type = type;
      } else {
        result[name] = {
    ...
    CloudFormationTemplateContext.prototype.Metadata = function(o) {
      if (this._metadatas == null) {
        this._metadatas = {};
      }
      return this._set(o, this._metadatas);
    };
    ...
    CloudFormationTemplateContext.prototype.ImportValue = function(arg) {
      return {
        'Fn::ImportValue': arg
      };
    };
    ...
    CloudFormationTemplateContext.prototype.Sub = function() {
      var args, subString, vars;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    ...
    CloudFormationTemplateContext.prototype.And = function() {
      var conditions;
      conditions = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return {
        'Fn::And': conditions
      };
    };
  ...
  module.exports = function(func) {
    ...
    if (context._metadatas != null) {
      template.Metadata = context._metadatas;
    }
    return template;
  };
